...
<head>
    ...
    <style type="text/css">
        ...
        <%
                Boolean showBorders = (Boolean) request.getAttribute("showBorders");
                if (showBorders == null) {
                    showBorders = false;
                }
                String borderStyle = showBorders ? "table, td, th {border: 1px solid;}" : "";
            %>
        <%= borderStyle %>
    </style>
</head>
...
<p>
    <fmt:formatDate value="${releaseDate}" type="date" dateStyle="short"/> <%--    Released: <c:out value="${releaseDate}" />--%>
</p>
